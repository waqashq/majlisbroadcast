...
Currently: Phase 6 (Gate 2: long-run validation), iterating on a reconnect-timing bug found in the first long-run test -- Phases 0, 0.5 Gate 1, 1, 2, 3, 4, and 5 complete.
